...
def _attribute_freturnt_parallel_SAVE( *args , RT , ovars , nslaw_class , side , mode , ci ):##{{{
...
def _attribute_creturnt_parallel_SAVE( *args , RT , ovars , nslaw_class , side , mode , ci ):##{{{
...
## run_bsac_cmd_attribute_fcreturnt_SAVE ##{{{
@log_start_end(logger)
def run_bsac_cmd_attribute_fcreturnt_SAVE(arg):
